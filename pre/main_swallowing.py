...
def loss_fucntion(a, b):
    ...
    for item in range(len(a)):
        # print("##########")
        # print(f"a[{0}].shape: {a[0].shape}, b[{0}].shape: {b[0].shape}")
        # print(f"a[{1}].shape: {a[1].shape}, b[{1}].shape: {b[1].shape}")
        # print(f"a[{2}].shape: {a[2].shape}, b[{2}].shape: {b[2].shape}")
        # print("##########")
...
def train(_class_):
    ...
    result_path = os.path.join("results_epoch", f"{_class_}.txt")
