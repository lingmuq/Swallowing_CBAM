...
def train(_class_):
    ...
    train_path = '/mnt/Data/Dataset/AnomalyDetection/mvtec_anomaly_detection/' + _class_ + '/train'
    test_path = '/mnt/Data/Dataset/AnomalyDetection/mvtec_anomaly_detection/' + _class_
    # train_path = './1111/' + _class_ + '/train'
    # test_path = './1111/' + _class_
    ckp_path = './checkpoints/mvtec/' + 'wres50_' + _class_ + '.pth'
